...
watch(() => props.show, (newVal) => {
 ...
 populateForm()
 // Autocomplete fetch is handled by DescriptionInput component now
 }
})
...
<template>
  ...
  >
    <div class="bg-canvas border border-card-border rounded-lg p-6 w-full max-w-3xl mx-4 max-h-[90vh] overflow-y-auto">
