...
<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-deep-green text-on-dark rounded-lg p-8 lg:p-12 mb-12 flex flex-col lg:flex-row lg:justify-between lg:items-end gap-8">
      <div>
        <p class="text-pale-green opacity-80 font-mono text-xs uppercase tracking-widest mb-2">
          Total Balance
        </p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
                  ...
                  >
                    ...
                    <div class="flex items-center gap-3 w-full sm:col-span-7">
                      ...
                      <div class="min-w-0 flex-1">
                        <span
                          class="text-sm text-gray-800 font-medium truncate block"
      ...
      <div class="lg:col-span-4 flex flex-col gap-12">
        <!-- Wallets Stack -->
        <div>
          <h2 class="font-display text-3xl tracking-tight text-ink mb-6">
            Wallets
          </h2>
        ...
        <div class="bg-soft-stone rounded-sm p-8">
          <h3 class="font-body font-medium text-lg text-ink mb-4">
            Top Spending
          </h3>
          <div class="space-y-3">
            <div
