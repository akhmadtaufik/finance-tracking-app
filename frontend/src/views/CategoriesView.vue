...
<template>
  <div class="max-w-4xl mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-8">
      <h1 class="font-display text-4xl tracking-tight text-ink">
        Categories
      </h1>
      <button
    ...
    <!-- Categories Grid -->
    <phantom-ui
      :loading="financeStore.isLoadingCategories"
      animation="shimmer"
    >
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        >
          <div class="flex items-center space-x-3">
            ...
            <div>
              <p class="font-body font-medium text-lg text-ink">
                {{ category.name }}
              </p>
              <div class="flex items-center space-x-2 mt-1">
                ...
                <span
                  ...
                  class="bg-transparent border rounded-sm px-2 py-0.5 font-mono text-xs uppercase tracking-wider border-slate text-slate"
                >
                  Global
                </span>
                <span
    ...
    >
      <div class="bg-canvas border border-card-border rounded-lg p-6 w-full max-w-md mx-4">
        ...
        <div
          v-if="error"
          class="bg-red-50 text-red-600 p-3 rounded-md text-sm mb-4"
        >
          {{ error }}
        </div>
        ...
        <div class="space-y-4">
          ...
          <div>
            ...
            <p class="text-xs text-gray-500 mt-1">
              Selected: {{ CATEGORY_ICONS.find(i => i.id === categoryIcon)?.name }}
            </p>
          </div>
        </div>
