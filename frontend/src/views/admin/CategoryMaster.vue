...
<template>
  <div class="p-8">
    ...
    >
      <!-- Income Categories -->
      <div class="bg-canvas border border-card-border rounded-xl border border-gray-100 overflow-hidden">
    ...
    >
      <div class="bg-canvas border border-card-border rounded-xl p-6 w-full max-w-md mx-4">
        ...
        <div
          v-if="error"
          class="bg-red-50 text-red-600 p-3 rounded-lg text-sm mb-4"
        >
          {{ error }}
        </div>
